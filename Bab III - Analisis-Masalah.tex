...
\caption{Kebutuhan Fungsional Sistem \textit{Chatbot Business Intelligence}}
...
FR-8 & Pendeteksian Anomali dan Nilai Pencilan & 
\textbf{Tujuan}: Mengidentifikasi titik data yang tidak normal atau berbeda signifikan dari tren historis untuk memberikan peringatan kepada pengguna. \\
& & \textbf{Masukan}: Data deret waktu indikator bisnis. \\
& & \textbf{Keluaran}: Identifikasi anomali, deskripsi penyimpangan, dan rekomendasi tindakan. \\
\hline

FR-9 & Visualisasi Data dan Ekspor Hasil & 
\textbf{Tujuan}: Menyediakan visualisasi grafik sederhana dan opsi ekspor data untuk analisis lebih lanjut. \\
& & \textbf{Masukan}: Data hasil analisis atau prediksi. \\
& & \textbf{Keluaran}: Grafik (grafik garis, grafik batang, grafik lingkaran) dan file ekspor (CSV, Excel). \\
\hline

FR-10 & Manajemen Riwayat Percakapan dan Sesi & 
...
FR-11 & Autentikasi dan Otorisasi Pengguna & 
...
FR-12 & Mekanisme Pengunduran dan Penanganan Kesalahan & 
...
\begin{longtable}{|p{1.3cm}|p{4.5cm}|p{7cm}|}
\caption{Kebutuhan Nonfungsional Sistem \textit{Chatbot Business Intelligence}}
...
\caption{Analisis \textit{Balanced Scorecard} untuk Solusi \textit{Chatbot} Berbasis Aturan Sederhana}
...
\begin{longtable}{|p{3.5cm}|p{9cm}|}
\caption{Analisis \textit{Balanced Scorecard} untuk Solusi \textit{Chatbot} BI Komprehensif}
...
\begin{longtable}{|p{3.5cm}|p{9cm}|}
\caption{Analisis \textit{Balanced Scorecard} untuk Solusi Dasbor BI Tradisional}
...
\caption{Matriks Perbandingan \textit{Balanced Scorecard} Alternatif Solusi}
...
Solusi yang dipilih juga sejalan dengan tren global di mana pasar kecerdasan buatan percakapan diproyeksikan mencapai USD 49,7 miliar pada tahun 2025 (Qaltivate, 2025), pasar pemrosesan bahasa alami tumbuh dengan CAGR 28,6\% mencapai USD 438,08 miliar pada tahun 2034 (Precedence Research, 2025), dan pasar peramalan deret waktu diperkirakan mencapai USD 36,9 miliar pada tahun 2032 (WiseGuy Reports, 2024). Pertumbuhan pasar yang eksponensial ini menunjukkan bahwa investasi dalam teknologi-teknologi ini bukan hanya relevan untuk saat ini, tetapi juga strategis untuk jangka panjang.