...
\multicolumn{3}{c}%
{\tablename\ \thetable\ -- {Kebutuhan Fungsional Sistem \textit{Chatbot Business Intelligence} (lanjutan)}} \\
\hline
\textbf{ID} & \textbf{Nama Kebutuhan} & \textbf{Deskripsi} \\
\hline
\endhead
...
\multicolumn{3}{c}%
{\tablename\ \thetable\ -- {Kebutuhan NonFungsional Sistem \textit{Chatbot Business Intelligence} (lanjutan)}} \\
\hline
\textbf{ID} & \textbf{Nama Kebutuhan} & \textbf{Deskripsi} \\
\hline
\endhead
...
\multicolumn{2}{c}%
{\tablename\ \thetable\ -- {Analisis \textit{Balanced Scorecard} untuk Solusi \textit{Chatbot} Berbasis Aturan Sederhana (lanjutan)}} \\
\hline
\textbf{Perspektif} & \textbf{Penilaian} \\
\hline
\endhead
...
\multicolumn{2}{c}%
{\tablename\ \thetable\ -- {Analisis \textit{Balanced Scorecard} untuk Solusi \textit{Chatbot} BI Komprehensif (lanjutan)}} \\
\hline
\textbf{Perspektif} & \textbf{Penilaian} \\
\hline
\endhead
...
\multicolumn{2}{c}%
{\tablename\ \thetable\ -- {Analisis \textit{Balanced Scorecard} untuk Solusi Dasbor BI Tradisional (lanjutan)}} \\
\hline
\textbf{Perspektif} & \textbf{Penilaian} \\
\hline
\endhead
...
\multicolumn{6}{c}%
{\tablename\ \thetable\ -- {Matriks Perbandingan \textit{Balanced Scorecard} Alternatif Solusi (lanjutan)}} \\
\hline
\textbf{Solusi} & \textbf{\textit{Financial}} & \textbf{\textit{Customer}} & \textbf{\textit{Process}} & \textbf{L\&G} & \textbf{Digunakan oleh} \\
\hline
\endhead
