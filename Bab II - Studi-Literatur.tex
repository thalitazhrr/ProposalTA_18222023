...
% ==============================================================================
\section{Pattern-Based Intent Classification dengan Confidence Level}
% ==============================================================================
...
\subsection{Konsep Intent Classification}
...
\subsection{Pattern Matching untuk Intent Classification}
...
\subsection{Confidence Score dalam Intent Classification}
...
\subsection{Evaluasi Performa Intent Classification}
...
\subsubsection{Metrik Evaluasi Intent Classification}

Model klasifikasi \textit{intent} dievaluasi menggunakan beberapa metrik standar yang memberikan gambaran komprehensif tentang performa sistem \parencite{spotintelligence2023intent,svm2025comparative}. Metrik pertama adalah \textit{Accuracy} yang mengukur proporsi prediksi yang benar dari total prediksi:

\begin{equation}
\text{Accuracy} = \frac{TP + TN}{TP + TN + FP + FN}
\end{equation}

Metrik kedua adalah \textit{Precision} yang mengukur proporsi prediksi positif yang benar:
\begin{equation}
\text{Precision} = \frac{TP}{TP + FP}
\end{equation}

\textit{Recall} sebagai metrik ketiga mengukur proporsi kasus positif aktual yang diprediksi dengan benar:
\begin{equation}
\text{Recall} = \frac{TP}{TP + FN}
\end{equation}

Metrik terakhir adalah \textit{F1-Score} yang merupakan rata-rata harmonik dari \textit{precision} dan \textit{recall}:
\begin{equation}
\text{F1-Score} = 2 \times \frac{\text{Precision} \times \text{Recall}}{\text{Precision} + \text{Recall}}
\end{equation}

Dalam formula-formula ini, $TP$ = \textit{True Positive}, $TN$ = \textit{True Negative}, $FP$ = \textit{False Positive}, dan $FN$ = \textit{False Negative}. Keempat metrik ini saling melengkapi dan memberikan perspektif yang berbeda tentang performa model.

\subsubsection{Confusion Matrix dan Confidence Score Analysis}
...
\subsubsection{Target Performa Intent Classification}
...
% ==============================================================================
\section{Template-Based Natural Language Generation}
% ==============================================================================
\begin{figure}[H] 
  \centering
  \includegraphics[width=0.46\textwidth,
...
\subsection{Konsep Natural Language Generation}
...
\subsection{Template-Based Natural Language Generation}
...
\subsection{Template Rewriting dengan Pre-trained Language Models}
...
\subsubsection{Differential Privacy untuk NLG}
...
\subsection{Evaluasi Kualitas Natural Language Generation}
...
\subsubsection{Metrik Task-Specific untuk BI Chatbot}
...
\subsection{Evaluasi Performa Time Series Forecasting}
...
\subsubsection{Metrik Evaluasi Forecasting}
...
\subsubsection{Cross-Validation untuk Time Series}
...
\subsubsection{Target Performa Forecasting}
...
\subsection{Arsitektur Chatbot Hibrida}
...
\subsubsection{Komponen Arsitektur Chatbot Modern}
...
\subsubsection{Chatbot Hibrida dengan AI dan Human Oversight}
...
\subsubsection{Pasar Chatbot AI Global}
...
\subsection{Integrasi Pattern-Based Intent dan Template-Based NLG}
...
\subsection{Customer Churn Prediction dengan Machine Learning}
...
\subsubsection{Model Machine Learning untuk Churn Prediction}
...
\subsubsection{Evaluasi Model Churn Prediction}
...
\subsubsection{Fitur-fitur untuk Churn Prediction}
...
\subsubsection{Real-Time Churn Prediction}
...
\subsection{Integrasi Churn Prediction dengan Chatbot BI}
