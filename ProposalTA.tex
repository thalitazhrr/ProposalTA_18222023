...
% Judul Bab (BAB I, BAB II, ... dengan jarak atas diperkecil)
\renewcommand\thechapter{\Roman{chapter}}
\titleformat{\chapter}[display]
  {\centering\normalfont\Large\bfseries}
  {\MakeUppercase{\chaptertitlename}\ \thechapter}{0pt}{\Large}
%             left  before-sep  after-sep
\titlespacing*{\chapter}{0pt}{-2.6cm}{0.8em}

% Judul Subbab dan Subsubbab (rapi + jarak wajar)
