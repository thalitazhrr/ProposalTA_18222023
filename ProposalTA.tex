...
% % ==== Heading bab & jarak atas seragam (berlaku juga utk LoF/LoT/LoL) ====
% \renewcommand\thechapter{\Roman{chapter}}
% \titleformat{\chapter}[display]
%   {\centering\normalfont\Large\bfseries}
%   {\MakeUppercase{\chaptertitlename}\ \thechapter}{0pt}{\Large}
% \titlespacing*{\chapter}{0pt}{-2.0cm}{0.8em} % atur -2.0cm jika perlu lebih/kurang rapat

% % ToC/LoF/LoT: judul besar, rata tengah, tanpa jarak ekstra di atas
...
% % Nama daftar listing (tanpa \centering/\normalsize agar format heading tidak kacau)
% \renewcommand{\lstlistlistingname}{DAFTAR KODE}

% ==========================================
% AWAL DOKUMEN
% ==========================================
% --- Tabel rapi & kolom fleksibel ---
\usepackage{tabularx,booktabs,array,ragged2e,enumitem}
\newcolumntype{Y}{>{\RaggedRight\arraybackslash}X}          % kolom fleksibel
\newcolumntype{L}[1]{>{\RaggedRight\arraybackslash}p{#1}}   % p{} ragged-right
\newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}}     % p{} centered
\newcolumntype{R}[1]{>{\RaggedLeft\arraybackslash}p{#1}}    % p{} ragged-left
...
\begin{center}
  ...
  \vspace*{2cm}
    ...
    {\large\bfseries PERANCANGAN SISTEM \textit{BUSINESS INTELLIGENCE} BERBASIS \textit{CHATBOT} DENGAN \textit{RULE-BASED QUERY}, \textit{NATURAL LANGUAGE PROCESSING}, DAN \textit{TIME SERIES FORECASTING} UNTUK ANALISIS DAN PREDIKSI KINERJA BISNIS}\\
     \vspace{4cm}
